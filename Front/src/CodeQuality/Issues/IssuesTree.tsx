                ...
                <DiffInfo>
                    {details.blocker !== 0 && (
                        <>
                            ...
                            <ApproximateUnits value={details.blocker} units={ITEMS_UNITS} />
                        </>
                    )}{" "}
                    {details.critical !== 0 && (
                        <>
                            <SeverityIcon type="critical" />
                            <ApproximateUnits value={details.critical} units={ITEMS_UNITS} />
                        </>
                    )}{" "}
                    {details.major !== 0 && (
                        <>
                            <SeverityIcon type="major" />
                            <ApproximateUnits value={details.major} units={ITEMS_UNITS} />
                        </>
                    )}{" "}
                    {details.minor !== 0 && (
                        <>
                            <SeverityIcon type="minor" />
                            <ApproximateUnits value={details.minor} units={ITEMS_UNITS} />
                        </>
                    )}{" "}
                    {details.info !== 0 && (
                        <>
                            <SeverityIcon type="info" />
