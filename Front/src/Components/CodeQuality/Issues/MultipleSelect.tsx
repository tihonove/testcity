...
export function MultipleSelect({ caption, items, selected, onChange }: MultipleSelectProps) {
    const renderTooltip = (): React.JSX.Element => (
    ...
    return (
        <Tooltip render={renderTooltip} trigger="click" pos="bottom left" useWrapper closeButton={false}>
