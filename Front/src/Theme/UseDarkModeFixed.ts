...
/**
 * NOTE
 * Удалить когда пофиксят https://github.com/juliencrn/usehooks-ts/issues/512
 * PR я закинул, который чинит
 */
...
export function useDarkMode(options: DarkModeOptions = {}): DarkModeReturn {
    ...
    const [isDarkMode, setDarkMode] = useLocalStorage<boolean | undefined>(localStorageKey, defaultValue, {
        initializeWithValue,
    });
