...
houston create release -a $HOUSTON2_API_TOKEN --application $HOUSTON2_APP_ID --binaries-name Kontur.TestAnalytics.Api --binaries-version $current_version -v $current_version --path-to-settings-folder .houston-configuration
